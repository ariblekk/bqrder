...
export default function ProductPicker({
  ...
  const unit = (variant?.price ?? product.price) + options.reduce((s, o) => s + o.price, 0)
  ...
  return (
    <Sheet open={open} onOpenChange={onOpenChange}>
      <SheetContent side="bottom" showCloseButton={false} className="mx-auto max-h-[85dvh] w-full max-w-2xl overflow-y-auto rounded-t-2xl">
